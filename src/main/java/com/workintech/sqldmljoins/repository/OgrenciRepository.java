...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    //String QUESTION_4 = "SELECT sinif, COUNT(ogrno) AS kitap_sayisi FROM ogrenci WHERE sinif IN ('10A', '10B') GROUP BY sinif";
    String QUESTION_4 = "SELECT o.sinif, COUNT(i.kitapno) FROM ogrenci o INNER JOIN islem i ON o.ogrno = i.ogrno WHERE (o.sinif = '10A' OR o.sinif='10B') GROUP BY o.sinif";
    @Query(value = QUESTION_4, nativeQuery = true)
    List<KitapCount> findClassesWithBookCount();

    //Öğrenci tablosundaki öğrenci sayısını gösterin
    String QUESTION_5 = "SELECT COUNT(o.*) FROM ogrenci o";
